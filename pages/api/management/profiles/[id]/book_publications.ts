...
import type { BookPublication, Profile } from '@prisma/client'
...
const postHandler = async (req: NextApiRequest, res: NextApiResponse, session: Session) => {
  const body = JSON.parse(req.body) as Partial<BookPublication>
  ...
  await prisma.$transaction([
    prisma.profileToBookPublicationBridge.deleteMany({
      where: {
        book_publication: {
          id: body.id
        }
