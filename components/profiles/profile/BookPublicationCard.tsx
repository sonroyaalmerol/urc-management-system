...
import { ExtendedBookPublication } from '../../../types/profile-card'
import VerifiedTag from '../../VerifiedTag'

const BookPublicationCard: React.FC<{entry: ExtendedBookPublication}> = (props) => {
...
export default BookPublicationCard
