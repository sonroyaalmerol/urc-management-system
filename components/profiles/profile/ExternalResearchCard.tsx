...
import { ExtendedExternalResearch } from '../../../types/profile-card'
import VerifiedTag from '../../VerifiedTag'

const ExternalResearchCard: React.FC<{entry: ExtendedExternalResearch}> = (props) => {
...
export default ExternalResearchCard
