...
import type { ExtendedProfile, ExtendedResearchEvent } from '../../../../types/profile-card'
...
const ResearchEventModal: React.FC<{
  entry: ExtendedResearchEvent,
        ...
        <ModalBody>
          ...
          { roleChecker(session.data.profile, MODIFY_RESEARCHER_PROFILE) && (
            <Wrap>
              <WrapItem>
                <ButtonWithConfirmation 
                  ...
                  confirmationMessage={`
                    You are about to remove ${entry.event_name} from the profile. Do you want to proceed?
                  `}
                  isLoading={deleting}
                  leftIcon={<CloseIcon />}
                  onClick={async () => {
                    ...
                    const res = await fetch(
                      `${process.env.NEXT_PUBLIC_BASE_URL}/api/management/profiles/${profile.id}/research_events`, {
                        method: 'DELETE',
              ...
              <WrapItem>
                <ButtonWithConfirmation 
                  ...
                  confirmationMessage={`
                    You are about to delete ${entry.event_name} from ALL profiles. Do you want to proceed?
                  `}
                  isLoading={deleting}
                  leftIcon={<DeleteIcon />}
                  onClick={async () => {
            ...
            <Wrap align="center">
              ...
              <WrapItem>{entry.description}</WrapItem>
            </Wrap>
            <Wrap align="center">
...
export default ResearchEventModal
