...
import type { ExtendedProfile, ExtendedResearchDissemination } from '../../../../types/profile-card'
...
const ResearchDisseminationModal: React.FC<{
  entry: ExtendedResearchDissemination,
                ...
                <ButtonWithConfirmation 
                  ...
                  onClick={async () => {
                    ...
                    const res = await fetch(
                      `${process.env.NEXT_PUBLIC_BASE_URL}/api/management/profiles/${profile.id}/research_disseminations`, {
                        method: 'DELETE',
...
export default ResearchDisseminationModal
