...
import { ExtendedResearchPresentation } from '../../../types/profile-card'
import VerifiedTag from '../../VerifiedTag'

const ResearchPresentationCard: React.FC<{entry: ExtendedResearchPresentation}> = (props) => {
...
export default ResearchPresentationCard
